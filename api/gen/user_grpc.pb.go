...
const (
	UserService_GetCurrentUser_FullMethodName        = "/bocchi.user.v1.UserService/GetCurrentUser"
	UserService_UpdateUserPreferences_FullMethodName = "/bocchi.user.v1.UserService/UpdateUserPreferences"
)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bocchi.user.v1.UserService",
